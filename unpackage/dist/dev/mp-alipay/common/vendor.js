...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"post_sale","VUE_APP_PLATFORM":"mp-alipay","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 17:
/*!***********************************************!*\
  !*** D:/保留/项目/post_sale/utils/datarequest.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var app = getApp();
    ...
    uni.request({
      ...
      success: function success(res) {
        if (res.data.code == 1009) {//重新获取accesstoken
          uni.request({
            url: app.globalData.apiurl + 'accesstoken',
            header: {
              'content-type': 'application/x-www-form-urlencoded' },
            ...
            success: function success(e) {
              if (e.data.code == 1000) {
                app.globalData.accesstoken = e.data.token;
                POST1(url, params, inum);
              }
            } });

        } else {
          _vue.default.prototype.netWorkData.result[inum] = res.data;
          resolve();
        }
      } });
...
function POST1(url, params, inum) {//post提交,同步
  var promise = new Promise(function (resolve, reject) {
    uni.request({
      url: app.globalData.apiurldiy + url,
      header: {
        'content-type': 'application/x-www-form-urlencoded',
        'authorization': app.globalData.accesstoken },
...
function getqrcode(bid) {//生成二维码
  ...
  if (access_token != "" && bid > 0) {
    ...
    this.POST(iurl, idata, 7).then(function () {
...
function relogin() {//重新登录
  ...
  this.POST1(irurl, idata, 8).then(function () {
    var user_data = app.netWorkData.result[8];
    if (user_data.code == 1000) {
      app.globalData.userInfo = user_data.data[0];
    }
  });
}
...
/***/ 18:
/*!****************************************!*\
  !*** D:/保留/项目/post_sale/utils/util.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function getiImg(url, img) {var types = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  if (img == "" || img == null) {
    return false;
  }
  var array = img.split(",");
...
function successPopup(info, url) {
  uni.showToast({
    ...
    complete: function complete() {} //接口调用结束的回调函数
  });
}
...
{var content = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { showCancel: true };
...
function countDown(num) {
  var set = setInterval(function (res) {
    --num;
    console.log(num);
  }, 1000);
  setTimeout(function () {
