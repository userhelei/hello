<template>
	<view>
		...
		<view class="details">
			...
			<view class="product">
				<view class="appointment-list-lines">
					...
					<view class="list-line-right product-img" v-if="detailsData.questionimages.length!=0">
						<view class="product-bg" v-for="(qitem,oindex) in detailsData.questionimages" :key="oindex" @tap="ViewImage" :data-url="detailsData.questionimages[oindex]">
							<image mode="aspectFill" class="product-imgs" :style="{height: productImg}" :src="qitem"></image>
						</view>
					</view>
			...
			<view class="product">
				<view class="appointment-list-line">
					<view class="list-line-left" style="width: 28%;"><text>工程师姓名</text><text>:</text></view>
					<view class="list-line-right" style="width: 72%;">{{detailsData.engineer_name}}</view>
				</view>
				<view class="appointment-list-lines pd-tb-30">
					<view class="list-line-left"><text>联 系 人</text><text>:</text></view>
					<view class="list-line-right">{{detailsData.engineer_mobile}}</view>
				</view>
			</view>
		</view>
	</view>
