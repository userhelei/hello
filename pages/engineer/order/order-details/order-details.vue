		...
		<view class="details">
			...
			<view class="product">
				<view class="appointment-list-lines">
					...
					<view class="list-line-right product-img" v-if="details.questionimages.length!=0">
						<view class="product-bg" v-for="(item,index) in details.questionimages" :key="index" @tap="ViewImage" :data-url="details.questionimages[index]">
							<image mode="aspectFill" class="product-imgs" :style="{height: productImg}" :src="item"></image>
						</view>
					</view>
